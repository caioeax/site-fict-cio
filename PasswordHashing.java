 ...
 * Algoritmos de hash com PBKDF2: PBKDF2WithHmacSHA1, PBKDF2WithHmacSHA256,
...
public abstract class PasswordHashing {
    ...
    /**
     * Método que recebe uma senha, um salt e um algoritmo de hash e retorna o hash
     * da senha
     * 
     ...
     */
    public static byte[] hashPasswordWithMessageDigest(char[] password, byte[] salt, String algorithm) throws NoSuchAlgorithmException {
     ...
     * @return true se a senha fornecida é igual ao hash da senha armazenado, false caso contrario
     * @throws NoSuchAlgorithmException caso o algoritmo de hash não exista
     */
    public static boolean verifyPasswordWithMessageDigest(char[] password, byte[] salt, String algorithm,
            byte[] hashedPassword) throws NoSuchAlgorithmException {
        return MessageDigest.isEqual(hashPasswordWithMessageDigest(password, salt, algorithm),
                hashedPassword);
    }

    /**
     * Método que recebe uma senha, um salt, um algoritmo de hash, número de
     * iterações e tamanho
    ...
    public static boolean verifyPasswordWithPBKDF2(char[] password, byte[] salt, String algorithm,
            int iterations, int keyLength, byte[] hashedPassword)
            throws NoSuchAlgorithmException, InvalidKeySpecException {
        Base64.Encoder encoder = Base64.getEncoder();
        return encoder.encodeToString(hashPasswordWithPBKDF2(password, salt, algorithm, iterations, keyLength))
                .equals(encoder.encodeToString(hashedPassword));
    }
